document.addEventListener("DOMContentLoaded", () => {
  ...
  // Container for radio buttons - choices
  ...
  function showQuestion() {
    ...
    progressBar.style.width = quiz.currentQuestionIndex
      ? `${number}%`
      : `${0}%`; // This value is hardcoded as a placeholder
    ...
    // question.choices.shuffleChoices();
    const questionChoicesArray = question.choices;

    questionChoicesArray.map((element) => {
      // console.log("element: ", element);
      let divContainerForLabelAndRadio = document.createElement("div");
      choicesContainer.appendChild(divContainerForLabelAndRadio);
      // Add div and append it to body and then add input and label inside the div and use flex direction to adjust the position
